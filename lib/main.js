    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (testResult.message.statusCode == 200) {
            ...
            if (validate) {
                ...
                if (!util_1.isNullOrUndefined(testObj.passFailCriteria) && !util_1.isNullOrUndefined(testObj.passFailCriteria.passFailMetrics))
...
function createTestRun() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const runDisplayName = core.getInput('loadTestRunDisplayName');
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (!util.isTerminalTestStatus(testStatus)) {
            ...
            if (util.isTerminalTestStatus(testStatus)) {
                let vusers = null;
                let count = 0;
                while (util_1.isNullOrUndefined(vusers) && count < 4) {
                ...
                if (!util_1.isNullOrUndefined(testRunObj.passFailCriteria) && !util_1.isNullOrUndefined(testRunObj.passFailCriteria.passFailMetrics))
                    util.printCriteria(testRunObj.passFailCriteria.passFailMetrics);
                if (testRunObj.testRunStatistics != null) {
                    if (octokit && (context_payload === null || context_payload === void 0 ? void 0 : context_payload.number)) {
