...
function printClientMetricsMarkdown(obj) {
    if (Object.keys(obj).length == 0)
        return "";
...
exports.printClientMetricsMarkdown = printClientMetricsMarkdown;
